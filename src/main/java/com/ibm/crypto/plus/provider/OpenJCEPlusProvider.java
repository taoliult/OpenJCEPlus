...
public abstract class OpenJCEPlusProvider extends java.security.Provider {
    ...
    private static final String PROVIDER_VER = SystemAccessUtils.getProperty("java.specification.version", "17");

    private static final String JAVA_VER = SystemAccessUtils.getProperty("java.specification.version", "17");

    static final String DEBUG_VALUE = "jceplus";

    static final boolean allowLegacyHKDF = Boolean.parseBoolean(
            SystemAccessUtils.getProperty("openjceplus.allowLegacyHKDF", "false"));
    ...
    OpenJCEPlusProvider(String name, String info) {
        ...
        numCleaners = Integer.parseInt(
                SystemAccessUtils.getProperty("openjceplus.cleaners.num",
    ...
    ProviderException providerException(String message, Throwable throwable) {
        return new ProviderException(message, throwable);
    }

    void setExceptionCause(Exception exception, Throwable throwable) {
    ...
    protected static class OpenJCEPlusService extends Service {
        ...
        public Object newInstance(Object constructorParameter) throws NoSuchAlgorithmException {
            ...
            Class<?> cls;
            try {
                cls = SystemAccessUtils.loadClass(className);
            ...
            try {
                ...
                if (openjceplusClass == null) {
                    try {
                        openjceplusClass = SystemAccessUtils.loadClass(
