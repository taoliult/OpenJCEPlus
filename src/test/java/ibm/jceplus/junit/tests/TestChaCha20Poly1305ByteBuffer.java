...
public class TestChaCha20Poly1305ByteBuffer extends BaseTest {
    ...
    private static final byte[] TEST_KEY_BYTES = BaseUtils.hexStringToByteArray(
            "3cb1283912536e4108c3094dc2940d0d020afbd7701de267bbfb359bc7d54dd7");
    private static final byte[] TEST_NONCE_BYTES = BaseUtils.hexStringToByteArray(
    ...
    private static final byte[] TEST_CT_BYTES = BaseUtils.hexStringToByteArray(
    ...
    public void testUpdateAAD() throws Exception {
        ...
        /* Test 4: Place the AAD, followed by plaintext and verify
         * the ciphertext.
         */
